...
@Component
public class IntegrationStatementMedicareLive {

	public String readInvestigationDataByConsultationNo(Long consultationNo) {

		StringBuilder sql = new StringBuilder();
		sql.append(" SELECT OPD_CONDTL_NO, OPD_CONDTL_ID, APPOINTMENT_NO, ");
	...
	public String creatInvestigationQuery() {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(" INSERT INTO OPD_CONSULTATION_DETAIL (OPD_CONDTL_NO, OPD_CONDTL_ID, APPOINTMENT_NO, ");
		sql.append(" OPD_CONSULTATION_NO, ITEM_NO, ITEMTYPE_NO, ITEM_QTY, ");
		sql.append(" DELIVERY_STATUS_NO, ITEM_NAME, SUBITEMTYPE_NO, ");
	...
	public String updateInvestigationData() {
		...
		sql.append(" ITEMTYPE_NO = ?, ITEM_QTY = ?, ITEM_NAME = ?, SUBITEMTYPE_NO = ? ");
