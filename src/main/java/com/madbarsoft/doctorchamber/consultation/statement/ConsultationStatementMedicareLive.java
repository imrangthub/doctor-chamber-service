...
@Component
public class ConsultationStatementMedicareLive implements CommonFunctions{

	public static String opd_consultation_web_v(Map<String, String> queryMap) {	
		boolean andFlag = false;
		StringBuilder sqlQuery = new StringBuilder();
		
		sqlQuery.append("SELECT opd_consultation_no,dob ,opd_consultation_id, consultation_dt, SHIFTDTL_NO, ");
	 ...
	 if(queryMap.containsKey("opdConsultationId") ) {
		 if(andFlag) {sqlQuery.append(" AND ");}
			sqlQuery.append(" OPD_CONSULTATION_ID like UPPER(");
			sqlQuery.append("'%"+queryMap.get("opdConsultationId")+"%')");
		
	 }
	 
	 if(queryMap.containsKey("opdHospitalNo") ) {
		 if(andFlag) {sqlQuery.append(" AND ");}
			sqlQuery.append(" HOSPITAL_NUMBER like UPPER(");
			sqlQuery.append("'%"+queryMap.get("opdHospitalNo")+"%')");
	...
	public static String opd_consultation_web_v_app(Map<String, String> queryMap) {	
		...
		sqlQuery.append("select opd_consultation_no, opd_consultation_id, consultation_dt, shiftdtl_no, appoint_date, ");
	...
	public static String opd_consultation_find_by_consultation_Id(ConsultationEntity reqObj) {			
		StringBuilder sqlQuery = new StringBuilder();
		sqlQuery.append("SELECT opd_consultation_no, opd_consultation_id, appoint_no as appointment_no, SHIFTDTL_NO, ");
	...
	public static String opd_consultation_find_by_hospital_number(String hnNumber) {			
		...
		sqlQuery.append("SELECT opd_consultation_no, opd_consultation_id, SHIFTDTL_NO, ");
		sqlQuery.append(" DOCTOR_NO AS doctor_no,CONSULT_IN AS consult_in, CONSULT_OUT AS consult_out, ");
		sqlQuery.append(" patient_name AS full_name, ");
