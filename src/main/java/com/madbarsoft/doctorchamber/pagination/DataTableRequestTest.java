package com.madbarsoft.doctorchamber.pagination;
...
public class DataTableRequestTest {
	 ...
	 */
	public DataTableRequestTest(HttpServletRequest request) {
	...
	public String toString() {
		return "DataTableRequestTest [uniqueId=" + uniqueId + ", draw=" + draw + ", start=" + start + ", length="
				+ length + ", search=" + search + ", regex=" + regex + ", columns=" + columns + ", order=" + order
